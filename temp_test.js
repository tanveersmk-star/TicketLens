...
- TIMELINE DETAIL: For each event, extract:
  ...
  * Message summary (if communication, extract the FULL message verbatim, do NOT summarize or skip parts of the section)
  ...
  "timeline": [
    {
      ...
      "message_summary": "string — if this was a communication, extract the FULL message verbatim without skipping parts",
